...
TMUX_STYLES_PANE_BORDER_STYLE="${TMUX_STYLES_BG_COLOR}"
TMUX_STYLES_PANE_ACTIVE_BORDER_STYLE="${TMUX_STYLES_MENU_COLOR}"
...
export TMUX_STYLES_PANE_BORDER_STYLE
export TMUX_STYLES_PANE_ACTIVE_BORDER_STYLE
