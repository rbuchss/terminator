...
-
# column types
regexp=(?i)\b(INT|TINYINT|SMALLINT|MEDIUMINT|BIGINT|FLOAT|DOUBLE|DECIMAL|DATE|DATETIME|TIMESTAMP|TIME|YEAR|CHAR|VARCHAR|BLOB|TEXT|TINYBLOB|TINYTEXT|MEDIUMBLOB|MEDIUMTEXT|LONGBLOB|LONGTEXT|ENUM|UNSIGNED)\b
colours=bold green
-
# data in ( ) and ' '
regexp=\([\w\d,']+\)
